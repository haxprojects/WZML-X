...
desp_dict = {'rcc': ['RClone is a command-line program to sync files and directories to and from different cloud storage providers like GDrive, OneDrive...', 'Send rclone.conf. \n<b>Timeout:</b> 60 sec'],
            ...
            'doodstream': ['doodstream is a free file sharing and storage platform. You can store and share your content without any limit.', "Send doodstream's API Key. Get it on https://doodstream.com, It will not be Accepted if the API Key is Invalid !!\n<b>Timeout:</b> 60 sec"],
            }

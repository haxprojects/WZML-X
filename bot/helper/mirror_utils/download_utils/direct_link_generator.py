...
def direct_link_generator(link):
    ...
    elif any(x in domain for x in ['dood.watch', 'doodstream.com', 'dood.to', 'dood.so', 'dood.cx', 'dood.la', 'dood.ws', 'dood.sh', 'doodstream.co', 'dood.pm', 'dood.wf', 'dood.re', 'dood.video', 'dooood.com', 'dood.yt', 'doods.yt', 'dood.stream', 'doods.pro', 'ds2play.com', 'dood.boo', 'dood.zip', 'poop.media', 'dood.boo', 'doodx.pro', 'tem.pics', 'poop.cx', 'ds2video']):
        return doods(link)
...
def doods(url):
    cget = create_scraper().request
    try:
        req = cget('GET', f'https://v2.pake.tk/dood?url={url}')
